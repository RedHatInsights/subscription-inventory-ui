...
const Cards: FunctionComponent<StatusCardProps> = ({  statusCardData, statusIsFetching }) => (
  <QueryClientProvider client={queryClient}>
    <StatusCountCard statusCardData={statusCardData} statusIsFetching={statusIsFetching} setFilter={() => {}} />
  </QueryClientProvider>
);
...
describe('StatusCountCard', () => {
  ...
  it('renders correctly', () => {
    const { container } = render(
      <Cards statusCardData={get('data')} statusIsFetching={get('fetching')} setFilter={() => {}}/>
    );
